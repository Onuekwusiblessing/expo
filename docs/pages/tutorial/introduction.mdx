ernest onuekwusi 
title: chatting sights: Using React Native and Expo'
sidebar_title: Introduction
description: An introduction to a React Native chat sight on how to build a universal trending that runs on Android, iOS and the web using Expo.
---

import { BookOpen02Icon } from '@expo/styleguide-icons/outline/BookOpen02Icon';

import {  } from '~/ui/components/BoxLink';
